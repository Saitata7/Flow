...
const StatsTimeBased = ({ flow, selectedPeriod, setSelectedPeriod, selectedYear, setSelectedYear }) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={[styles.header, dynamicStyles.header]}>Time-based Flow Statistics</Text>
      ...
      <View style={styles.statsContainer}>
        <Text style={[styles.statsText, dynamicStyles.header]}>
          {selectedMetric === 'total' ? 'Total Time' : selectedMetric === 'average' ? 'Average Session' : 'Trend'}
        </Text>
        <Text style={[styles.statsValue, dynamicStyles.header]}>
          {selectedMetric === 'total' ? '25h 30m' : selectedMetric === 'average' ? '45m' : '+8%'}
        </Text>
      </View>
    </View>
  );
